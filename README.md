...
<!DOCTYPE html>
<!-- saved from url=(0033)http://zxycc.cc/demo/canvas/line/ -->
<html><style type="text/css" id="2156260000"></style><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
...
if(document.URL.indexOf("v.qq.com") >= 0){
	...
	<body>
		<canvas id="myCanvas" width="1440" height="708"></canvas>
